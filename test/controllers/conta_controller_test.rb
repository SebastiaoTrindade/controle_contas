...
class ContaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contum" do
    assert_difference("Contum.count") do
      post conta_url, params: { contum: { data_vencimento: @contum.data_vencimento, descricao: @contum.descricao, nome_empresa: @contum.nome_empresa, status: @contum.status, valor: @contum.valor } }
    end
  ...
  test "should update contum" do
    patch contum_url(@contum), params: { contum: { data_vencimento: @contum.data_vencimento, descricao: @contum.descricao, nome_empresa: @contum.nome_empresa, status: @contum.status, valor: @contum.valor } }
